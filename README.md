...
## Resources
- Data Source: [crypto_data.csv](https://github.com/Morifingk/Cryptocurrencies/blob/main/Resources/crypto_data.csv), [CryptoCompare](https://min-api.cryptocompare.com/data/all/coinlist)
